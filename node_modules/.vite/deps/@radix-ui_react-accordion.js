...
import {
  useId
} from "./chunk-EENRQK72.js";
import {
  createCollection
} from "./chunk-XTVDQCOT.js";
import {
  Presence,
  Primitive,
...
// ../../node_modules/.pnpm/@radix-ui+react-accordion@1.2.20_@types+react-dom@19.2.3_@types+react@19.2.17__@types+r_6f43c3344a8f52bc850742fe65537110/node_modules/@radix-ui/react-accordion/dist/index.mjs
var React3 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@radix-ui+react-collapsible@1.1.20_@types+react-dom@19.2.3_@types+react@19.2.17__@types_72edc584deedfa66eccba6841b680d2b/node_modules/@radix-ui/react-collapsible/dist/index.mjs
...
// ../../node_modules/.pnpm/@radix-ui+react-direction@1.1.4_@types+react@19.2.17_react@19.1.0/node_modules/@radix-ui/react-direction/dist/index.mjs
...
var Accordion = React3.forwardRef(
  // blank line to reduce diff noise
  __name3(function Accordion2(props, forwardedRef) {
...
var AccordionImplSingle = React3.forwardRef(
  // blank line to reduce diff noise
  __name3(function AccordionImplSingle2(props, forwardedRef) {
    const {
      value: valueProp,
      defaultValue,
      onValueChange = __name3(() => {
      }, "onValueChange"),
      collapsible = false,
...
var AccordionImplMultiple = React3.forwardRef(__name3(function AccordionImplMultiple2(props, forwardedRef) {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = __name3(() => {
...
var AccordionImpl = React3.forwardRef(
  __name3(function AccordionImpl2(props, forwardedRef) {
    ...
    const handleKeyDown = composeEventHandlers(props.onKeyDown, (event) => {
      ...
      const moveNext = __name3(() => {
        nextIndex = triggerIndex + 1;
        if (nextIndex > endIndex) {
          nextIndex = homeIndex;
        }
      }, "moveNext");
      const movePrev = __name3(() => {
        nextIndex = triggerIndex - 1;
...
var AccordionItem = React3.forwardRef(
  __name3(function AccordionItem2(props, forwardedRef) {
...
var AccordionHeader = React3.forwardRef(
  // blank line to reduce diff noise
  __name3(function AccordionHeader2(props, forwardedRef) {
...
var AccordionTrigger = React3.forwardRef(
  // blank line to reduce diff noise
  __name3(function AccordionTrigger2(props, forwardedRef) {
...
var AccordionContent = React3.forwardRef(
  // blank line to reduce diff noise
  __name3(function AccordionContent2(props, forwardedRef) {
